...
const RESERVED = new Set( ["toJSON", "WebGLRenderingContext", "WebGL2RenderingContext", "innerHTML", "URLSearchParams"] );
        ...
        "schema": [
            {
                ...
                "properties": {
                    ...
                    "allowConsecutiveCapitalLetters": {
                        "type": "boolean",
                        "default": true,
                    },
                    "properties": {
    ...
    create ( context ) {
        ...
        function isUnderscored ( name ) {
            ...
            if ( name.startsWith( "API_" ) ) {
                if ( !/^API_[a-z]\w*$/.test( name ) ) return true;

                if ( /[A-Z]{2,}/.test( name.substr( 4 ) ) ) return true;
            ...
            if ( !options.allowConsecutiveCapitalLetters && /[A-Z]{2,}/.test( name ) && !RESERVED.has( name ) ) return true;
